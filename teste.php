<?php  
    ...
    <form method="post">
        ...
        <button type="submit" data-toggle="modal" class="btn btn-primary btn-block btn-large" data-target="#criarCadastro">Criar novo cadastro</button>
    </form>
</div>';
    }
?>
...
<body>
    ...
    if(is_null($nome) || is_null($senha)){
        ...
        $q = "SELECT id_cad, cpf, nome, senha, tipo_negocio FROM dividas WHERE nome = '$nome'";
        ...
        if(!$busca){
            ...
            if($busca->nuw_rows > 0){
                ...
                if(testarHash($senha, $registro->senha)){
                    ...
                    $_SESSION['cpf_dividas'] = $registro->tipo;
                    $_SESSION['id_cad'] = $registro->id_usuario;
                } else{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_ke">
        <!-- onsubmit="return salvarCadastro(event)" -->
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="negocio" id="negocio" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
